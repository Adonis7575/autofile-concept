...
const notes = SEED.map(([title, body, path], i) => ({ id:"s"+i, title, html:"<p>"+body+"</p>", path }));
...
const meeting = classify({ title: "DataFlow sync", html:
...
const research = classify({ title: "Background jobs", html:
...
const idea = classify({ title: "Gamified code review", html:
...
const withRule = classify({ title: "Northwind follow up", html:
...
const noise = classify({ title: "", html:
...
const inject = classify({ title: "Pasted email", html:
